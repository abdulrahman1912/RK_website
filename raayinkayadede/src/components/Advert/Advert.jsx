    ...
    return(
        <>
            <div className="w-full mt-10">
                <img src={Bgimage} alt="nophoto" className="w-full h-95vh object-cover" />
                        ...
                        <div className="w-full md:w-3/4 flex flex-col justify-center items-center">
                            <div className="flex flex-col items-center  mb-6 gap-5">
                                <div className="w-full flex flex-col gap-2">
                                    <h3 className="text-5xl font-bold text-red-500  self-center">12+</h3>
                                    <div className="w-20 h-2 bg-white rounded-full self-center"></div>
                                    <h4 className="text-2xl text-white font-semibold">Completed Projects</h4>
                                    <p className="text-white text-lg">We have completed a lot of projects successfully with our experience.</p>
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <h3 className="text-5xl font-bold text-red-500 self-center">100%</h3>
                                    <div className="w-20 h-2 bg-white rounded-full self-center"></div>
                                    <h4 className="text-2xl text-white font-semibold">Satisfied Customers</h4>
                                    <p className="text-white text-lg">Every family who live in our buildings are 100% satisfied with our support and construction.</p>
                                </div>
                                <div className="w-full flex flex-col gap-2">
                                    <h3 className="text-5xl font-bold text-red-500 self-center">2648+</h3>
                                    <div className="w-20 h-2 bg-white rounded-full self-center"></div>
                                    <h4 className="text-2xl text-white font-semibold">Working Hours</h4>
                                    <p className="text-white text-lg">We have worked a lot in the past 19 years to provide the best apartments to live.</p>
                                </div>
                            </div>
                            <div className="flex flex-col items-center mt-6">
                                <h1 className="text-4xl md:text-6xl text-white text-center mb-4">We believe that business can be a powerful force for <span className="text-red-500">good</span>.</h1>
                                <Button text={"Contact Us"} style={{marginTop:50}}/>
                            </div>
                        </div>
                    </div>
